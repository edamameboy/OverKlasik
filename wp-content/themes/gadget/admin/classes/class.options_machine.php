...
class Options_Machine {
	...
	public static function optionsframework_slider_function($id,$std,$oldorder,$order){
		...
		//initialize all vars
		$slidevars = array('title', 'url', 'vid_url', 'description', 'title_animation', 'desc_animation', 'button_text', 'button_url');
		...
		$slider .= '<label>Video URL</label>';
		$slider .= '<input class="slide of-input" name="'. $id .'['.$order.'][vid_url]" id="'. $id .'_'.$order .'_slide_vid_url" value="'. $val['vid_url'] .'" />';
